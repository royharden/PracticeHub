...
export const stripeAdapterContract: AdapterContract = {
  ...
  reconciliation:
    'landed-without-receipt is not a licence to send again; late webhooks attach to the original effect',
  ...
  livenessProof:
    'RAIL-008 stripe-sim four-class fixtures plus inbox gap/duplicate/out-of-order tests',

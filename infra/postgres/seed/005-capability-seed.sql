...
VALUES
  ...
  ('synthetic-cap-evt-0024', 'northwind-synthetic', 'ai.gateway', '{"feature":"draft-visit-summary","cohort":"cohort-alpha"}'::jsonb, 'cohort=cohort-alpha/feature=draft-visit-summary', 'disabled', 'scaffolded', 'synthetic-platform-bootstrap', '[{"approverRef":"synthetic-architecture-owner","role":"architecture"}]'::jsonb, '["synthetic-gate:wp-100-ai-gateway-scaffold"]'::jsonb, 'registry-event-replay', NULL, NULL, 'synthetic bootstrap chain', true),
  ('synthetic-cap-evt-0025', 'northwind-synthetic', 'ai.gateway', '{"feature":"draft-visit-summary","cohort":"cohort-alpha"}'::jsonb, 'cohort=cohort-alpha/feature=draft-visit-summary', 'scaffolded', 'simulated', 'synthetic-platform-bootstrap', '[{"approverRef":"synthetic-architecture-owner","role":"architecture"}]'::jsonb, '["synthetic-gate:wp-100-ai-gateway-simulated"]'::jsonb, 'registry-event-replay', NULL, NULL, 'synthetic bootstrap chain', true),
...
VALUES
  ('northwind-synthetic', 'ai.gateway', '{"feature":"draft-visit-summary","cohort":"cohort-alpha"}'::jsonb, 'cohort=cohort-alpha/feature=draft-visit-summary', 'simulated', 'synthetic-cap-evt-0025', '["synthetic-gate:wp-100-ai-gateway-simulated"]'::jsonb, 'registry-event-replay', true),
  ('northwind-synthetic', 'cash.paid-service-loop', '{}'::jsonb, '(root)', 'simulated', 'synthetic-cap-evt-0027', '["synthetic-gate:wp-031-paid-service-loop-simulated"]'::jsonb, 'registry-event-replay', true),
  ...
  ('northwind-synthetic', 'portal.intake', '{}'::jsonb, '(root)', 'simulated', 'synthetic-cap-evt-0029', '["synthetic-gate:portal-intake-simulated"]'::jsonb, 'registry-event-replay', true),
